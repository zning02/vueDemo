      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                <v-counter @on-change="countprice('buyNum',$event)"></v-counter>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
              ...
              <div class="sales-board-line-right">
                  <v-selection :selections="buyTypes" @on-change="countprice('buyType',$event)"></v-selection>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
              ...
              <div class="sales-board-line-right">
                  ...
                  @on-change="countprice('period',$event)"
                  ></v-chooser>
              </div>
          </div>
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  ...
                  @on-change="countprice('versions',$event)"></v-mul-chooser>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
